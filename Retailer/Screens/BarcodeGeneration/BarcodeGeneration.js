...
import { fetchDataAndAddToSanityNewBarcode } from '../../../sanity';
import { TextInput } from 'react-native-paper';

const BarcodeGeneratorApp = ({ route }) => {
    ...
    const generateBarcode = async () => {
        ...
        console.log(product);
        await fetchDataAndAddToSanityNewBarcode(product, newBarcodeData, price); // Pass price to the database
    };
